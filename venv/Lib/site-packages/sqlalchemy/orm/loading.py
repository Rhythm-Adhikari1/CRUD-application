...
def merge_frozen_result(session, statement, frozen_result, load=True):
    ...
    ctx = querycontext.ORMSelectCompileState._create_entities_collection(statement)
...
def merge_result(query, iterator, load=True):
    ...
    ctx = querycontext.ORMSelectCompileState._create_entities_collection(query, True)
