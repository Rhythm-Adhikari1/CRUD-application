...
class ORMSelectCompileState(ORMCompileState, SelectState):
    ...
    def create_for_statement(cls, statement, compiler, **kw):
        ...
        self.from_clauses = [info.selectable for info in select_statement._from_obj]
        ...
        for element in statement._raw_columns:
            if element.is_selectable and "entity_namespace" in element._annotations:
                for elem in _select_iterables(
                    element._annotations["entity_namespace"]._all_column_expressions
                ):
                    yield elem
            else:
    ...
    def _join_left_to_right(
        ...
        if replace_from_obj_index is not None:
            ...
            if use_entity_index is not None:
                ...
                # might be distinct
                assert isinstance(self._entities[use_entity_index], _MapperEntity)
            ...
            if entity.is_clause_element:
                if entity.is_selectable:
                    ...
                    if entity._annotations.get("bundle", False):
                        ...
                        _ColumnEntity._for_columns(compile_state, [entity], idx)
...
class _BundleEntity(_QueryEntity):
    ...
    def __init__(self, compile_state, expr, setup_entities=True, parent_bundle=None):
        compile_state._has_orm_entities = True
...
class _ColumnEntity(_QueryEntity):
    ...
    @classmethod
    def _for_columns(cls, compile_state, columns, raw_column_index, parent_bundle=None):
...
class _RawColumnEntity(_ColumnEntity):
    ...
    def __init__(self, compile_state, column, raw_column_index, parent_bundle=None):
        self.expr = column
